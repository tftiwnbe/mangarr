...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "section", "source_id", "page", "rank", name="uq_discover_cache_items_rank"
        ),
    )
    op.create_index(
        op.f("ix_discover_cache_items_dedupe_key"),
        "discover_cache_items",
        ["dedupe_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_discover_cache_items_page"),
        "discover_cache_items",
        ["page"],
        unique=False,
    )
    op.create_index(
        op.f("ix_discover_cache_items_section"),
        "discover_cache_items",
        ["section"],
        unique=False,
    )
    op.create_index(
        op.f("ix_discover_cache_items_source_id"),
        "discover_cache_items",
        ["source_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "variant_ids_json", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_download_profiles_enabled"),
        "download_profiles",
        ["enabled"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_profiles_library_title_id"),
        "download_profiles",
        ["library_title_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_profiles_paused"),
        "download_profiles",
        ["paused"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_profiles_preferred_variant_id"),
        "download_profiles",
    ...
    op.create_index(
        op.f("ix_download_tasks_attempt_group_id"),
        "download_tasks",
        ["attempt_group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_available_at"),
        "download_tasks",
        ["available_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_chapter_id"),
        "download_tasks",
        ["chapter_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_library_title_id"),
        "download_tasks",
        ["library_title_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_priority"), "download_tasks", ["priority"], unique=False
    )
    op.create_index(
        op.f("ix_download_tasks_retry_of_task_id"),
        "download_tasks",
        ["retry_of_task_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_source_id"),
        "download_tasks",
        ["source_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_tasks_status"), "download_tasks", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_download_tasks_variant_id"),
        "download_tasks",
        ["variant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_collections_name"),
        "library_collections",
        ["name"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column("thumbnail_url", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "local_cover_path", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("description", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column("artist", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column("author", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(
        op.f("ix_library_titles_canonical_key"),
        "library_titles",
        ["canonical_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_titles_preferred_variant_id"),
        "library_titles",
        ["preferred_variant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_titles_user_status_id"),
        "library_titles",
        ["user_status_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_user_statuses_key"),
        "library_user_statuses",
        ["key"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_persistent_cache_expires_at"),
        "persistent_cache",
        ["expires_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_download_profile_variants_position"),
        "download_profile_variants",
        ["position"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_profile_variants_profile_id"),
        "download_profile_variants",
        ["profile_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_download_profile_variants_variant_id"),
        "download_profile_variants",
        ["variant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_integration_api_keys_key_hash"),
        "integration_api_keys",
        ["key_hash"],
        unique=True,
    )
    op.create_index(
        op.f("ix_integration_api_keys_user_id"),
        "integration_api_keys",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_collection_titles_collection_id"),
        "library_collection_titles",
        ["collection_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_collection_titles_library_title_id"),
        "library_collection_titles",
        ["library_title_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_title_variants_library_title_id"),
        "library_title_variants",
        ["library_title_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_title_variants_source_id"),
        "library_title_variants",
        ["source_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_chapters_is_downloaded"),
        "library_chapters",
        ["is_downloaded"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_chapters_is_read"),
        "library_chapters",
        ["is_read"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_chapters_library_title_id"),
        "library_chapters",
        ["library_title_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_chapters_reader_page_index"),
        "library_chapters",
        ["reader_page_index"],
        unique=False,
    )
    op.create_index(
        op.f("ix_library_chapters_variant_id"),
        "library_chapters",
        ["variant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_chapter_comments_chapter_id"),
        "library_chapter_comments",
        ["chapter_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_library_chapter_pages_chapter_id"),
        "library_chapter_pages",
        ["chapter_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_library_chapter_pages_chapter_id"), table_name="library_chapter_pages"
    )
    op.drop_table("library_chapter_pages")
    op.drop_index(
        op.f("ix_library_chapter_comments_chapter_id"),
        table_name="library_chapter_comments",
    )
    op.drop_table("library_chapter_comments")
    op.drop_index(op.f("ix_library_chapters_variant_id"), table_name="library_chapters")
    op.drop_index(
        op.f("ix_library_chapters_reader_page_index"), table_name="library_chapters"
    )
    op.drop_index(
        op.f("ix_library_chapters_library_title_id"), table_name="library_chapters"
    )
    op.drop_index(op.f("ix_library_chapters_is_read"), table_name="library_chapters")
    op.drop_index(
        op.f("ix_library_chapters_is_downloaded"), table_name="library_chapters"
    )
    op.drop_table("library_chapters")
    op.drop_table("sources")
    op.drop_index(
        op.f("ix_library_title_variants_source_id"), table_name="library_title_variants"
    )
    op.drop_index(
        op.f("ix_library_title_variants_library_title_id"),
    ...
    op.drop_index(
        op.f("ix_integration_api_keys_user_id"), table_name="integration_api_keys"
    )
    op.drop_index(
        op.f("ix_integration_api_keys_key_hash"), table_name="integration_api_keys"
    )
    ...
    op.drop_index(
        op.f("ix_library_user_statuses_key"), table_name="library_user_statuses"
    )
    op.drop_table("library_user_statuses")
    op.drop_index(op.f("ix_library_titles_user_status_id"), table_name="library_titles")
    op.drop_index(
        op.f("ix_library_titles_preferred_variant_id"), table_name="library_titles"
    )
    ...
    op.drop_index(
        op.f("ix_download_tasks_retry_of_task_id"), table_name="download_tasks"
    )
    op.drop_index(op.f("ix_download_tasks_priority"), table_name="download_tasks")
    op.drop_index(
        op.f("ix_download_tasks_library_title_id"), table_name="download_tasks"
    )
    ...
    op.drop_index(
        op.f("ix_download_tasks_attempt_group_id"), table_name="download_tasks"
    )
    op.drop_table("download_tasks")
    op.drop_index(
        op.f("ix_download_profiles_preferred_variant_id"),
        table_name="download_profiles",
    )
    op.drop_index(op.f("ix_download_profiles_paused"), table_name="download_profiles")
    op.drop_index(
        op.f("ix_download_profiles_library_title_id"), table_name="download_profiles"
    )
    ...
    op.drop_index(
        op.f("ix_discover_cache_items_source_id"), table_name="discover_cache_items"
    )
    op.drop_index(
        op.f("ix_discover_cache_items_section"), table_name="discover_cache_items"
    )
    op.drop_index(
        op.f("ix_discover_cache_items_page"), table_name="discover_cache_items"
    )
    op.drop_index(
        op.f("ix_discover_cache_items_dedupe_key"), table_name="discover_cache_items"
    )
