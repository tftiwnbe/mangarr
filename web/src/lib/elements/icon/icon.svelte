<script lang="ts">
	...
	const icons: Record<string, string> = {
		...
		'eye-off':
			'M2 2l20 20M9.88 9.88a3 3 0 1 0 4.24 4.24M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 11 7 11 7a13.16 13.16 0 0 1-1.67 2.68M6.61 6.61A13.526 13.526 0 0 0 1 12s4 7 11 7a9.74 9.74 0 0 0 5.39-1.61',
		...
		// Misc
		globe:
			'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 18c-1.5 0-3-2.5-3.5-6h7c-.5 3.5-2 6-3.5 6zm-4-8c0-.7.1-1.4.2-2h7.6c.1.6.2 1.3.2 2s-.1 1.4-.2 2H8.2c-.1-.6-.2-1.3-.2-2zm4-8c1.5 0 3 2.5 3.5 6h-7c.5-3.5 2-6 3.5-6z',
		...
		maximize:
			'M8 3H5a2 2 0 0 0-2 2v3M21 8V5a2 2 0 0 0-2-2h-3M8 21H5a2 2 0 0 1-2-2v-3M16 21h3a2 2 0 0 0 2-2v-3',
